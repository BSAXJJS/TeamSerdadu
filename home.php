<?php
    ...
    if(!isset($_SESSION["login"])){
        ...
        $pass_db =  "swAqpJqnsu%5&j\&";
        $nama_db =  $coki;
    
        $konekdb = mysqli_connect($host_db, $user_db, $pass_db, $nama_db);
        $konekkrnjg = mysqli_query($konekdb, "SELECT * FROM keranjang");
    }
    ...
    <style>
        ...
        @media screen and (max-width: 500px) {
            ...
            nav .navigationWrapper .slide {
                transform:  translate(33px, 57px) scale(1);
            }
...
<body>
    ...
    <div>
        ...
        <div class="swiper container-sm mySwiper" id="product">
            <div class="product">
                <h1 class="prdct">Our Product</h1>
            </div>
            <div class="swiper-wrapper">
                <div class="container card-wraper swiper-slide">
                    <div class="card1 card">
                        <div class="card-content">
                            <h3 class="card-title">Kerang Mute<br><br></h3>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content. Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis non error natus a veniam optio, ea pariatur, praesentium, officiis quia ratione commodi soluta quam modi sint officia</p>
                        </div>
                    </div>
                </div>
                <div class="container card-wraper swiper-slide">
                    <div class="card2 card">
                        <div class="card-content">
                            <h3 class="card-title">Motif Palm<br><br></h3>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content. Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis non error natus a veniam optio, ea pariatur, praesentium, officiis quia ratione commodi soluta quam modi sint officia</p>
                        </div>
                    </div>
                </div>
                <div class="container card-wraper swiper-slide">
                    <div class="card3 card">
                        <div class="card-content">
                            <h3 class="card-title">Mandala<br><br></h3>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content. Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis non error natus a veniam optio, ea pariatur, praesentium, officiis quia ratione commodi soluta quam modi sint officia</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="keranjang">
        <?php while($row = mysqli_fetch_assoc($konekkrnjg)) :?>
            <tr>
